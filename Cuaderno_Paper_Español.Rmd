...
petro_1 <- read_excel("Datos/#petro (25_03) (1).xlsx")
petro_2 <- read_excel("Datos/#Petro_1 (25_03_23).xlsx")


laboral_1 <- read_excel("Datos/ReformaLaboral(25_03).xlsx")
laboral_2 <- read_excel("Datos/ReformasLaboral_1(01_04.xlsx")

pensional_1 <- read_excel("Datos/ReformaPensional(25_03).xlsx")
pensional_2 <- read_excel("Datos/ReformasPensional_1(01_04.xlsx")

salud_1 <- read_excel("Datos/ReformaSalud(25_03).xlsx")
salud_2 <- read_excel("Datos/ReformasSalud_1(01_04.xlsx")

petros_comments <- read_csv("Datos/FinalData2.csv")
```

**Segundo**, importamos datos finacieros

```{r}
ColeqtyIndex <- read_excel("Datos/ColeqtyIndex.xlsx")
#ts_sentiment <- read_excel("Datos/ts_sentiment.xlsx") # Daos del paper version 1
trmindex <- read_excel("Datos/TRMIndex.xlsx")
